...
def test_column_label_single_language() -> None:
    ...
    assert cl.column_label("holdings_value") == "持仓"
    assert cl.column_label("total_assets") == "总额"
    ...
    assert cl.column_label("holdings_value") == "Holdings (ref. price)"
    assert cl.column_label("total_assets") == "Total assets"
